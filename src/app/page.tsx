...
import EnergyConsumptionCalculator from '@/components/features/EnergyConsumptionCalculator'; // Import new component
...
import { MessageCircle, HelpCircle, ShieldAlert, Bot, Menu, BarChart3, ListChecks, Calculator } from 'lucide-react'; // Import Calculator
...
export default function HomePage() {
  ...
  const getTabName = (tabValue: string) => {
    ...
    if (tabValue === 'calculator') return 'Energy Calculator'; // New tab name
    return 'AI Chat';
  };
    ...
    <div className="flex flex-col min-h-screen bg-background text-foreground">
      ...
      <main className="flex-grow container mx-auto px-2 sm:px-4 py-6 sm:py-8">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          {/* Desktop Tab List */}
          <TabsList className="hidden sm:grid w-full grid-cols-3 md:grid-cols-6 mb-6 rounded-lg p-1 bg-muted relative z-10"> {/* Updated grid-cols */}
